...
OutputDir=${basedir}
OutputBaseFilename=SosrsSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\Sosrs.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-aarch64\Sosrs.jar"; DestDir: "{app}"
