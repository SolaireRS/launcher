...
OutputDir=${basedir}
OutputBaseFilename=SolaireRSSetupAArch64

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-aarch64\SolaireRS.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-aarch64\SolaireRS.jar"; DestDir: "{app}"
