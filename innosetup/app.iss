...
OutputDir=${basedir}
OutputBaseFilename=SolaireRSSetup

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${basedir}\build\win-x64\SolaireRS.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${basedir}\build\win-x64\SolaireRS.jar"; DestDir: "{app}"
