...
cp native/build-x86/src/Release/SolaireRS.exe build/win-x86/
cp target/SolaireRS.jar build/win-x86/
...
echo SolaireRS.exe 32bit sha256sum
sha256sum build/win-x86/SolaireRS.exe

dumpbin //HEADERS build/win-x86/SolaireRS.exe
