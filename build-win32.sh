...
cp native/build-x86/src/Release/Sosrs.exe build/win-x86/
cp target/Sosrs.jar build/win-x86/
...
echo Sosrs.exe 32bit sha256sum
sha256sum build/win-x86/Sosrs.exe

dumpbin //HEADERS build/win-x86/Sosrs.exe
