...
cp native/build-x64/src/Release/SolaireRS.exe build/win-x64/
cp target/SolaireRS.jar build/win-x64/
...
echo SolaireRS.exe 64bit sha256sum
sha256sum build/win-x64/SolaireRS.exe

dumpbin //HEADERS build/win-x64/SolaireRS.exe
