...
cp native/build-x64/src/Release/Sosrs.exe build/win-x64/
cp target/Sosrs.jar build/win-x64/
...
echo Sosrs.exe 64bit sha256sum
sha256sum build/win-x64/Sosrs.exe

dumpbin //HEADERS build/win-x64/Sosrs.exe
